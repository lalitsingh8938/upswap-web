...
//       };
//       if (!formData.startNow && formData.startTime) {
...
//           {!formData.startNow && (
//   <div className="mb-4">
//     <h3 className="text-gray-700 mb-2 font-semibold">Start Time</h3>
//     <input
//       type="datetime-local"
//       name="startTime"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        infinite_time: formData.infiniteTime,
        set_current_datetime: formData.startNow,
        location: formData.location, // Send the location string
         latitude: formData.latitude,  //  remove latitude
         longitude: formData.longitude, //  remove longitude
        uploaded_images: uploadedImages,
      };
      if (!formData.startNow && formData.startTime) {
        const [startDate, startTime] = formData.startTime.split("T");
