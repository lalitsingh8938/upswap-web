...
//           Authorization: `Bearer ${accessToken}`, // Token in headers
//         },
...
//         <img src="/UPswaplogo.png" alt="Logo" className="h-16" />
//       </div>

//       {/* OTP Text */}
//       <h2 className="text-lg font-bold mb-2">Enter your passcode</h2>
//       <p className="text-gray-600 text-sm mb-6">
//         We've sent a code through your phone number on your device
//       </p>
...
//         className="w-48 bg-orange-500 text-white py-2 rounded-md hover:bg-orange-600"
//         disabled={loading}
//       >
...
//   // Get phone number from localStorage (Ensure it's already set)
...
//     if (!phone) {
//       setMessage("Phone number is missing. Please request OTP again.");
//       setLoading(false);
//       return;
//     }

//     // Send phone number and OTP to the backend
